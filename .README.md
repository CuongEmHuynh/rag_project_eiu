...
# ETL
1. Lấy file dữ liệu từ Minio
2. Đọc dữ liệu database và dữ liệu file
3. Embbeding toàn bộ dữ liệu (10 cột)
4. Đưa dữ liệu vào vector database
5. Thực hành kiểm thử và đo độ chính xác.